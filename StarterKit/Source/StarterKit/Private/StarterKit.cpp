...
{
	std::string playerIdStr = std::to_string(_AShooterPlayerController->GetLinkedPlayerIDField());
	...
	// Send chat message
	FString steamName = playerController->GetPlayerStateField()->GetPlayerNameField();
